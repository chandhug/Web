...
const DEV_CONFIG = {
  CYPRESS_USER_USERNAME: 'qa@health.com',
  ...
  CYPRESS_USER_SERVICE_BASE_URL: 'http://user-service.dev.svc.cluster.local:5000/user/api/v1/',
  CYPRESS_MLAPI_BASE_URL: 'http://kong-kong-proxy.kong-dev.svc.cluster.local/',
  CYPRESS_LOGIN_PAGE_BASE_URL: 'http://atc-service.dev.svc.cluster.local',
...
const TEST_CONFIG = {
  ...
  CYPRESS_USER_SERVICE_BASE_URL: 'https://apps.health.com/appsvc/user/api/v1/',
  //'http://user-test-service.test.svc.cluster.local:5000/user/api/v1/',
  CYPRESS_MLAPI_BASE_URL: 'http://kong-kong-proxy.kong-test.svc.cluster.local/',
  CYPRESS_LOGIN_PAGE_BASE_URL: 'https://apps.health.com/',
  CYPRESS_AUTHENTICATION_TEST_USERID: '8357',
  CYPRESS_AUTHENTICATION_TEST_USERNAME: 'qa@health.com',
  CYPRESS_USER_FULL_NAME: 'Auto User',
  CYPRESS_URL: 'https://guide.apps.health.com/'
}
